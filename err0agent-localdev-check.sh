#!/bin/bash
#
# err0agent-localdev-check.sh - Check error codes using err0.io agent (local build)
#
# Usage:
#   ./err0agent-localdev-check.sh <token-file> <project-directory>
#
# Example:
#   ./err0agent-localdev-check.sh tokens/err0-django-*.json django
#
...
echo "/usr/local/bin/err0.sh --token $DOCKER_MOUNT/$1 --analyse --check $DOCKER_MOUNT/$2"
