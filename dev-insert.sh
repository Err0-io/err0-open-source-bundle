#!/bin/bash
#
# dev-insert.sh - Insert error codes for all configured projects
#
# This script runs insert operations on all projects listed in
...
echo "========================================"
echo "err0.io Bulk Insert Operation"
echo "========================================"
echo ""
...
while IFS= read -r project || [ -n "$project" ]; do
    ...
    echo "Running insert operation..."

    # Run insert operation
    if ./err0agent-dev-insert.sh "$TOKEN_FILE" "$project"; then
